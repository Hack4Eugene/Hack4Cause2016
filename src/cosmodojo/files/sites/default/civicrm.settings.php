...
if (!defined('CIVICRM_UF_DSN')) {
  define( 'CIVICRM_UF_DSN'           , 'mysql://biodelic_dojoadm:ewBZCZBIkQ3Y@localhost/biodelic_coder_dojo_drupal?new_link=true');
}
...
if (!defined('CIVICRM_DSN')) {
  define( 'CIVICRM_DSN'          , 'mysql://biodelic_dojoadm:ewBZCZBIkQ3Y@localhost/biodelic_coder_dojo_civicrm?new_link=true');
}
...
$civicrm_root = '/home1/biodelic/public_html/coderdojo/sites/all/modules/contrib/civicrm';
if (!defined('CIVICRM_TEMPLATE_COMPILEDIR')) {
  define( 'CIVICRM_TEMPLATE_COMPILEDIR', '/home1/biodelic/public_html/coderdojo/sites/default/files/civicrm/templates_c/');
}
...
if (!defined('CIVICRM_UF_BASEURL')) {
  define( 'CIVICRM_UF_BASEURL'      , 'http://coderdojo.cordslatton.com/');
}
...
//  $civicrm_setting['Directory Preferences']['extensionsDir'] = '/home1/biodelic/public_html/coderdojo/sites/default/files/civicrm/extensions/';
...
if (!defined('CIVICRM_SITE_KEY')) {
  define( 'CIVICRM_SITE_KEY', 'c9982d4ff3df2fa0ffd1c6b3af1d2c0f');
}
...
// define( 'CIVICRM_MAIL_LOG', '/home1/biodelic/public_html/coderdojo/sites/default/files/civicrm/templates_c//mail.log');
// }
